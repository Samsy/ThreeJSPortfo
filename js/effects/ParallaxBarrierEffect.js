...
THREE.ParallaxBarrierEffect = function ( renderer ) {
	...
	var _material = new THREE.ShaderMaterial( {
		...
		fragmentShader: [
			...
			"	vec4 col = texture2D( mapLeft, uv );",

			"		gl_FragColor = vec4(1.0 - col.r, 1.0 - col.g,1.0 - col.b,1.0 - col.a) ;",
	...
	this.render = function ( scene, camera, ratio ) {
		...
		// if ( hasCameraChanged ) {
			...
			var eyeSep = focalLength / 30 * 0.5 * ratio;
